<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterClientes.Master" CodeBehind="DefaultClientes.aspx.vb" Inherits="agenciaViajes.DefaultClientes" %>
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center intro">
            <div class="col-md-7 text-center element-animate">
                ...
                <p><a href="LoginClientes.aspx" class="btn btn-black">Reservar</a></p>
            </div>
        </div>
    </div>
</section>
