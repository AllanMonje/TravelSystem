...
Partial Public Class ActividadesDestinoTablaAdmin
    
    '''<summary>
    '''Control gvActividadesDestino.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents gvActividadesDestino As Global.System.Web.UI.WebControls.GridView
