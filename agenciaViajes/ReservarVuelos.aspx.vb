    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            ...
            If Session("usuario") IsNot Nothing Then
                ...
                precioreserva = Val(TextBox3.Text) + precio

                Dim cadena As String = "INSERT INTO reserva_vuelo VALUES( '" & txtNombre.Text & "','" & txtIdentidadPasajero.Text & "' , '" & DropDownList2.SelectedValue & "','" & id2 & "', '" & txtTarjeta.Text & "', '" & DropDownList1.SelectedValue & "', '" & DropDownList3.SelectedValue & "', '" & TextBox1.Text & "', '" & TextBox2.Text & "', '" & precio & "', '" & lblReservacion.Text & "' , 1)"
                ...
                Server.Transfer("~/ReservarHotel.aspx")
